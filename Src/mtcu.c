...
void setChannelsMTCU()
{
  ...
  for(uint8_t i = 0; i< 100;i++) // Search the DMA buffer for start byte; MyAddress
        {
  ...
  for(uint8_t i = 0; i< 4;i++) // Move the 4 bytes of data from the DMA ring buffer to the input_line array
    {
